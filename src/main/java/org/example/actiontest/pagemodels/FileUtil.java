...
/**
 * Common file commonUtil methods extended from org.apache.commons.io.FileUtils.
 */
...
public class FileUtil extends FileUtils {
    ...
    public static Boolean isEmptyFile(final File file, long fileLengthLimit) throws IOException {
    ...
    public static String saveImageFile(String base64Str, String prefix, String dir) throws IOException {
    ...
    public static String saveImageFile(BufferedImage bImag, String prefix, String dir) throws IOException {
        File file = generateFile(prefix, ".png", dir);
     ...
     * "/var/dto/images/xyz.png"; String root = "/var/dto"; return value will be
     * "images/xyz.png"
     *
     * @param root
     * @param filePath
    ...
    public static String getReletivePath(String root, String filePath) {
        return new File(root).toURI().relativize(new File(filePath).toURI()).getPath();
    }

    public static File generateFile(String prefix, String suffix, String dir) {
        if (counter == -1) {
    ...
    public static void appendFile(String fileName, StringBuilder sb) throws IOException {
    ...
    public static boolean isEmptyFile(String source) {
        try {
