...
public final class ClassUtil {
    ...
    public static Set<Method> getAllMethodsWithAnnotation(String packageName, Class<? extends Annotation> annotation) {
        ...
        try {
            ...
            System.out.println("ClassUtil.getAllMethodsWithAnnotation: " + e.getMessage());
        }
        ...
        while (resources.hasMoreElements()) {
            ...
            if (resource.getProtocol().equalsIgnoreCase(PROTOCOL_JAR)) {
                try {
                    ...
                    System.out.println("Unable to get classes from jar: " + resource);
                }
            } else {
                try {
        ...
        while (jarEntries.hasMoreElements()) {
            ...
            if (entryName.startsWith(pkg) && entryName.endsWith(CLASS_SUFIX)) {
                ...
                try {
                    ...
                    System.out.println("Unable to get class " + entryName + " from jar " + jarFileName);
                }
            }
        }
        jf.close();
